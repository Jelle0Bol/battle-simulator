...
class Battle
{
    ...
    public static void Fight(Trainer trainer1, Trainer trainer2, int[] scoreboard, ref int pokemon_trainer1, ref int pokemon_trainer2)
    {
        ...
        if (winner == "niemand")
        {
            ...
            {
                Console.WriteLine(trainer1.Name + " neemt terug " + trainer1.belt[pokemon_trainer1].pokemon?.name);
                trainer1.belt[pokemon_trainer1].closes();

                Console.WriteLine(trainer2.Name + " neemt terug " + trainer2.belt[pokemon_trainer2].pokemon?.name);
